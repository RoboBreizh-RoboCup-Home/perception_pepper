...
class Tracker(object):
  ...
  def apply(self, persons: List[PersonPose], timestamp: int) -> List[PersonPose]:
  ...
  @abc.abstractmethod
  def _compute_similarity(self, persons: List[PersonPose]) -> List[List[float]]:
  ...
  def _assign_tracks(self, persons: List[PersonPose], sim_matrix: List[List[float]],
                     timestamp: int) -> None:
