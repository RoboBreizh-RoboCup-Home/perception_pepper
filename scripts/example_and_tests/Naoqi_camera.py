...
from naoqi_camera_types import CameraID, CameraResolution2D as res2D, CameraResolution3D as res3D, ColorSpace2D as cs2D, ColorSpace3D as cs3D
...
class NaoqiSingleCamera(NaoqiCamera):
    ...
    def __init__(self, resolution: Union[res2D,res3D]= res2D.R320x240, camera_id: CameraID = CameraID.TOP, fps: int = 30, color_space: Union[cs2D, cs3D] = cs2D.RGBColorSpace, ip: str = "127.0.0.1"):
