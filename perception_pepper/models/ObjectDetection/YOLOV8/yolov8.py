...
class YOLOV8(Model):
    ...
    def get_model(self, model_name,_conf_threshold, _iou_threshold, inference_engine):
        ...
        self.path_catalog = {
            ...
            'type': 'onnx',
            'model_path':  'models/ObjectDetection/YOLOV8/weights/robocup/robocup.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/robocup/robocup.txt',
            'input_size': 320,
            },
            'ycb_320': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path':  'models/ObjectDetection/YOLOV8/weights/YCB/yolov8n_320_fp32.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/YCB/classes.txt',
            'input_size': 320,
            },
            'ycb_640': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/YCB/yolov8n_640.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/YCB/classes.txt',
            'input_size': 640,
            },
             'coco_320': {
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/coco/yolov8n_320.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/coco/coco.txt',
            'input_size': 320,
            },           
            'receptionist_320': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/receptionist/receptionist_320.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/receptionist/receptionist.txt',
            'input_size': 320,
            },
            'receptionist_640': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/receptionist/receptionist_640.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/receptionist/receptionist.txt',
            'input_size': 640,
            },
            'shoes_320': {
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/shoes/shoes_320v2.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/shoes/footwear.txt',
            'input_size': 320,
            },
            'clothes_320': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/clothes/clothes_320.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/clothes/clothes.txt',
            'input_size': 320,
            },
            'drinks_320': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/drink/drinks_320.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/drink/drink.txt',
            'input_size': 320,
            },
            'bag_320': {
            'engine' : inference_engine,
            ...
            '_iou_threshold': _iou_threshold, 
            'type': 'onnx',
            'model_path': 'models/ObjectDetection/YOLOV8/weights/bag/bag_320.onnx',
            'classes': 'models/ObjectDetection/YOLOV8/weights/bag/bag.txt',
            'input_size': 320,
            }            
        }
